...
<section class="py-20 bg-white font-sans">
    <div class="max-w-7xl mx-auto px-4 text-center">
        <span class="text-[10px] font-bold text-gray-500 uppercase tracking-widest border border-gray-200 px-3 py-1.5 rounded-full bg-gray-50">Real ChatGPT Monitoring</span>
        <h2 class="mt-8 text-5xl md:text-7xl font-serif-display text-gray-900 leading-tight">See what ChatGPT <br/> actually sees <br/> and cites</h2>
    </div>
    ...
    <div class="max-w-7xl mx-auto mt-16 px-4">
        <div class="border border-gray-200 rounded-xl overflow-hidden shadow-sm bg-white grid md:grid-cols-12 min-h-[600px]">
             <div class="md:col-span-4 p-8 md:p-12 border-r border-gray-200 flex flex-col justify-center">
                 <h3 class="text-3xl font-serif-display mb-4">Track citations across thousands of queries</h3>
                 <p class="text-gray-600 text-base leading-relaxed mb-8">Monitor your brand's visibility in real ChatGPT responses. See exactly when and how you're being cited, track trends over time, and identify content gaps where competitors are winning. Our real interface monitoring shows you what actual users see—not API approximations.</p>
                 <div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="border border-gray-100 rounded-lg overflow-hidden">
                            <div class="bg-gray-50 px-4 py-2 border-b border-gray-100 flex text-[10px] font-bold text-gray-500 uppercase tracking-wider">
                                <div class="w-1/3">Topic</div>
                                <div class="w-1/6 text-right">Citations</div>
                                <div class="w-1/6 text-right">Trend</div>
                                <div class="w-1/6 text-right">Your Rank</div>
                                <div class="w-1/6 text-right">Status</div>
                            </div>
                            <div class="divide-y divide-gray-50 text-xs">
                                 {#each [
                                     {kw: 'project management software', vol: '48', kd: '↑ 12%', cpc: '#1', status: 'Leading'},
                                     {kw: 'best collaboration tools', vol: '32', kd: '↑ 8%', cpc: '#3', status: 'Growing'},
                                     {kw: 'remote team software', vol: '27', kd: '→ 0%', cpc: '#2', status: 'Stable'},
                                     {kw: 'workflow automation', vol: '19', kd: '↓ 5%', cpc: '#5', status: 'Declining'},
                                     {kw: 'productivity apps 2024', vol: '15', kd: '↑ 22%', cpc: '#4', status: 'Rising'}
                                 ] as item}
                                 <div class="px-4 py-3 flex items-center hover:bg-gray-50 transition-colors">
                                     ...
                                     <div class="w-1/6 text-right">
                                         <span class="px-1.5 py-0.5 rounded text-[10px] font-bold {item.kd.includes('↑') ? 'bg-green-100 text-green-700' : item.kd.includes('↓') ? 'bg-red-100 text-red-700' : 'bg-gray-100 text-gray-700'}">{item.kd}</span>
                                     </div>
                                     <div class="w-1/6 text-right text-gray-600">{item.cpc}</div>
                                     <div class="w-1/6 text-right">
                                         <span class="text-[10px] font-bold text-gray-900">{item.status}</span>
                                     </div>
                                 </div>
                                 {/each}
                            </div>
        ...
        <div class="grid md:grid-cols-3 gap-0 mt-0 border-x border-b border-gray-200 divide-x divide-gray-200 bg-white">
            <div class="p-6 flex items-start gap-4 hover:bg-gray-50 transition-colors cursor-pointer">
                ...
                <p class="text-xs text-gray-600 leading-relaxed">Monitor real ChatGPT interface responses, not API approximations. See exactly what your customers see.</p>
            </div>
            <div class="p-6 flex items-start gap-4 hover:bg-gray-50 transition-colors cursor-pointer">
                ...
                <p class="text-xs text-gray-600 leading-relaxed">Track competitor citations and identify content gaps where they're winning. Get alerts when rankings change.</p>
            </div>
            <div class="p-6 flex items-start gap-4 hover:bg-gray-50 transition-colors cursor-pointer">
                ...
                <p class="text-xs text-gray-600 leading-relaxed">Receive AI-powered content recommendations to improve citation rates and visibility scores.</p>
            </div>
        </div>
    </div>
</section>